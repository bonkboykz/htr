...
import * as factorsSchema from "../factors/schema.js";

// Merge core + training + factors tables into a single schema namespace.
const schema = { ...coreSchema, ...trainingSchema, ...factorsSchema };
