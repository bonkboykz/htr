...
/// Secure storage for the HTR API key (single-user Bearer) and an optional
/// base-URL override. Mirrors qmeta's token storage.
class TokenStorage {
  final FlutterSecureStorage _s;
  TokenStorage([FlutterSecureStorage? s])
      : _s = s ?? const FlutterSecureStorage();

  static const _kApiKey = 'htr.apiKey';
  static const _kBaseUrl = 'htr.baseUrl';
